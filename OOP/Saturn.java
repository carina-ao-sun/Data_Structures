public class Saturn extends Currency implements Exchangeable {
    public Saturn(double totalFunds) {
        super("SaturnSilver", totalFunds,"Saturn");
    }
    ...
    public void exchange(Currency other, double amount) {
        ...
        if (totalFunds >= amount + fee) {
            ...
            System.out.println();
            System.out.printf("%.2f SaturnSilver = %.2f EarthDollars = %.2f %s", amount, USD, converted_fund, other.getCurrencyName());
            System.out.println();
            System.out.printf("Saturn exchange fee is %.2f SaturnSilver%n", fee);
            System.out.printf("Saturn has a total of %.2f SaturnSilver%n", totalFunds);
